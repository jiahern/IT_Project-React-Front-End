...
const Header = () => {
  return (
    <React.Fragment children>
      <div className="flex justify-between w-screen h-11.5 mt-1 w-full text-gray-700 bg-gray-100">
        <div className="taskBar flex w-100">
          <div className="flex items-center w-18 px-2.5 rounded hover:bg-gray-300">
            <button className="name_button ">
              <svg
                className="w-6 h-6 stroke-current strok-1"
                stroke="currentColor"
                viewBox="0 0 50 45"
                fill="none"
        ...
        <div className="flex space-x-4">
          ...
          <div className="flex-1">
            <button className="profileBarButton w-8 h-8 mt-4 mr-4">
              <svg
                className="ml-2"
                width="25"
                height="25"
            ...
            <div className="profileBar flex flex-col space-y-4 absolute right-0 w-40 rounded bg-blue-200 hidden">
      ...
      <div className=" flex flex-col h-full absolute top-14 -left-8 text-gray-700 bg-gray-100">
        <div className=" ml-1 mr-1 flex flex-col items-center w-18 transition duration-400">
          <a
          ...
          >
            ...
            <span
              className="nameHomepage hidden ml-2 text-sm font-medium"
              id="Homepage"
            >
              HomePage
            </span>
          ...
          <a
            className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300 transition duration-400"
            href="#"
          >
            <svg
              className="w-6 h-6 stroke-current"
            ...
            <span className="nameUnion hidden ml-2 text-sm font-medium" id="Union">
              Union
            </span>
          </a>
          <a
            className="flex items-center w-full h-12 px-3 mt-2 hover:bg-gray-300 transition duration-400"
            href="#"
          >
            <svg
              className="w-6 h-6 stroke-current"
            ...
            <span
              className="nameLinkage hidden ml-2 text-sm font-medium"
              id="Linkage"
            >
              Linkage
            </span>
          ...
          >
            ...
            <span className="nameTask hidden ml-2 text-sm font-medium" id="Task">
              Task
            </span>
          </a>
          <a
          ...
          >
            ...
            <span
              className="nameCalendar hidden ml-2 text-sm font-medium"
              id="Calendar"
            >
              Calendar
            </span>
