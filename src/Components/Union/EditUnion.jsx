    ...
    <section className="ShowUnion flex flex-col space-y-8">
      <div className="showUnionBelow w-full space-y-8">
        ...
        <div class="flex space-x-20">
          ...
          <input
            class={isRead ? "chooseImage unactive" : "chooseImage h-10 mt-20"}
            type="file"
            onChange={(event) => {
              fileSelectorHandler(event.target.files);
            }}
          />
        </div>
        <div class="flex">
          ...
          <div class="ml-4">
            ...
            <button
              ...
              className={
                isRead
                  ? "editButton font-bold rounded mr-10"
                  : "editButton unactive"
              }
              id="buttons"
            >
      ...
      <div className="scrollEditUnion">
        {linkages.map((item) => {
          return (
            ...
            >
              <div class="w-10 h-10">
                <img src={BASE_URL + item.profilePic} />
              </div>
              <div className="">
              ...
              <div
                className={
                  isRead
                    ? "addAndremove unactive"
                    : "addAndremove flex space-x-10 ml-40"
                }
              >
                <button
      ...
      <div class="flex">
        <button
          ...
          className={
            isRead
              ? "saveButton unactive"
              : "saveButton font-bold rounded ml-20"
          }
        >
          Save
        </button>
        ...
        <button
          onClick={() => setIsRead(!isRead)}
          className={
            isRead ? "cancelButton unactive" : "cancelButton font-bold rounded"
          }
        >
          Cancel
        </button>
